...
class BasicSecurityTweaks {

    /**
    * Block Bad User Queries
    * @source: https://perishablepress.com/block-bad-queries/
    */
    public function blockMaliciousUrlRequests() {
